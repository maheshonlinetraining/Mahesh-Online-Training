...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-['Plus_Jakarta_Sans',sans-serif] relative selection:bg-orange-500 selection:text-white">
      ...
      {/* Floating Action Button for Instant WhatsApp (Icon Only) */}
      <div className="fixed bottom-6 right-6 z-40">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-xl hover:shadow-2xl shadow-emerald-600/30 hover:scale-110 active:scale-95 transition-all duration-300"
          aria-label="Chat on WhatsApp"
          title="Chat on WhatsApp"
        >
          {/* Subtle pulse wave ring */}
          <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25 pointer-events-none group-hover:hidden"></span>
